...
describe SalesRepsController do
  ...
  let(:valid_attributes) { { "sales_group" => "" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sales_rep" do
        ...
        SalesRep.any_instance.should_receive(:update).with({ "sales_group" => "" })
        put :update, {:id => sales_rep.to_param, :sales_rep => { "sales_group" => "" }}, valid_session
      end
