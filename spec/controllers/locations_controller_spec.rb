...
describe LocationsController do
  ...
  let(:valid_attributes) { { "sales_rep" => "" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested location" do
        ...
        Location.any_instance.should_receive(:update).with({ "sales_rep" => "" })
        put :update, {:id => location.to_param, :location => { "sales_rep" => "" }}, valid_session
      end
